...
//
//  def dropdown(content: HtmlElement,
//               buttonText: String,
...
//               onclose: () => Unit) = {
//    lazy val trigger = button(buttonText, buttonSetters :+ dropdownToggle, buttonIcon).amend(span(caret, marginLeft := "4"))
//
//    new Dropdown(
//      content,
//      trigger,
...
//               dropdownSetters: HESetters,
//               onclose: () => Unit): Dropdown = new Dropdown(
//    content,
//    trigger,
//    allHESetters,
//    dropdownSetters,
...
//
//
//  class Dropdown(content: HtmlElement,
//                 trigger: HtmlElement,
//                 allHESetters: HESetters,
//                 dropdownSetters: HESetters,
//                 onclose: () => Unit) {
...
//            button(fixedTitle.getOrElse(c.map {
//              naming
