...
trait Base extends Selectors {
  ...
  //def json[S,T](file: String, f: js.Function2[S,T,Xhr]): Base = ???
...
trait Transition extends js.Object {
  ...
  def style(name: js.String, value: js.Any): Transition = ???
...
trait QuantitiveScale extends Scale {
  ...
  override def domain(values: js.Array[js.Any]): QuantitiveScale = ???

  override def domain(): js.Array[js.Any] = ???

  override def range(values: js.Array[js.Any]): QuantitiveScale = ???
...
trait TimeScale extends Scale {
  ...
  override def domain(values: js.Array[js.Any]): TimeScale = ???
