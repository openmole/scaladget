...
//    }
    ...
    val subContent2 = exclusiveRadio(Seq(ToggleState("One", btn_primary_string),ToggleState("Two",btn_primary_string), ToggleState("Three", btn_primary_string)), btn_secondary_string, ToggleState("Two", btn_primary_string), onToggled = _=> {})

    val tableWithSubs = dataTable()
      .addHeaders("First", "Second", "Actions")
      .addRow("0.0", "0,99", "0.88")
